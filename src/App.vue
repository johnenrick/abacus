            ...
            <ul v-if="user.type === 1" class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" >
                  ...
                  <router-link class="dropdown-item" to="user_management"><i class="fas fa-users"></i> User Management</router-link>
                  <h6 class="dropdown-header">Bus</h6>
                  <router-link class="dropdown-item" to="bus_list"><i class="fas fa-bus"></i> Bus List</router-link>
                  <router-link class="dropdown-item" to="bus_type"><i class="fas fa-th"></i> Bus Type</router-link>
                  <router-link class="dropdown-item" to="route_management"><i class="fas fa-map-marker"></i> Route</router-link>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" >
                  <router-link class="dropdown-item" to="bus_trip"><i class="fas fa-road"></i> Bus Trip</router-link>
                  <router-link class="dropdown-item" to="bus_trip_ticket"><i class="fas fa-ticket-alt"></i> Bus Trip Ticket</router-link>
                </div>
              </li>
              <li class="nav-item dropdown" >
                <a class="nav-link dropdown-toggle text-white pl-2" href="#"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" >
                  ...
                  <router-link class="dropdown-item" to="x_reading"><i class="fas fa-clipboard-list"></i> X - Reading</router-link>
                  <router-link class="dropdown-item" to="z_reading"><i class="fas fa-clipboard-list"></i> Z - Reading</router-link>
                  ...
                  <router-link class="dropdown-item" to="bus_daily_sales_report"><i class="fas fa-chart-line"></i> Daily Sales Report</router-link>
                  <router-link class="dropdown-item" to="route_sales_summary"><i class="fas fa-chart-line"></i> Route Sales Summary</router-link>
